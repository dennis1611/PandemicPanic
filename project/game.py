...
def choose_measure():
    ...
    for measure in measures:
        measure.menu()  # Should probably be measure.menu() eventually
    print('or "no measure" to take no action this turn')

    while True:
        measure_chosen = input('Your choice: ') # This could probably use a better name
...
while running:
    ...
    R.append(update_R(R[-1], measure_this_week.factor))
